...
export default function SignUp(){
  ...
  // sending data to db so it will take time so better use async
  const handleSubmit = async (e)=>{
    e.preventDefault();
    if(!formData.username || !formData.email || !formData.password){ // client side error , incomplete fields
    ...
    try{
        ...
        if( data.success === false ){ // server side error
